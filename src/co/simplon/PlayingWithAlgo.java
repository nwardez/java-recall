...
public class PlayingWithAlgo {
	...
	public static String[] reverseWordsInMyStringArray(String array[]) {
		...
		String result[] = new String[array.length]; // Tableau de retour
		
		for ( int i = array.length - 1; i >= 0; i --) { // Alimente l'arrayList des differentes chaines
			temp.add(array[i]);
		}
		
		for ( int i = 0; i < temp.size(); i ++) {
			int longueurDeChaine = temp.get(i).length();
			for ( int j = 0; j < longueurDeChaine; j ++) {
				// Récupérer le caractère un par un et inversé avec le caractère opposé
			}
		}
	...
	public static int[] sortTabBySelection(int[] array) { //________________________________________________________________________OK
	...
	public static int[] sortTabByInsertion(int[] array) { //________________________________________________________________________OK
		int i, j, temp;
	...
	public static int[] sortTabByBubble(int[] array) { //________________________________________________________________________OK
		int i, j, temp;
